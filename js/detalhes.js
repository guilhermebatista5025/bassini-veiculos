...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const equipmentsHtml = car.equipments.map(eq => `
    ...
    <div class="detail-grid">
      ...
      <div class="detail-gallery">
        <div class="main-image-container">
          <img id="main-gallery-img" src="../${car.image}" alt="${car.brand} ${car.model}">
        </div>
        <div class="thumbnail-list">
          <button class="thumbnail-btn active" onclick="updateGallery('../${car.image}', this)">
            <img src="../${car.image}" alt="Frente">
          </button>
          <button class="thumbnail-btn" onclick="updateGallery('../${car.image}', this)">
            <img src="../${car.image}" alt="Traseira">
          </button>
          <button class="thumbnail-btn" onclick="updateGallery('../${car.image}', this)">
            <img src="../${car.image}" alt="Lateral">
          </button>
          <button class="thumbnail-btn" onclick="updateGallery('../${car.image}', this)">
            <img src="../${car.image}" alt="Interior">
          </button>
        </div>
      </div>
      ...
      <div class="detail-info-panel">
        <div class="detail-header-block">
          <div class="brand-badge">
            ${car.brandLogoUrl ? `<img src="../${car.brandLogoUrl}" alt="${car.brand}" class="brand-badge-logo">` : ""}
            <span>${car.brand}</span>
          </div>
